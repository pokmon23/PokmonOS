...
typedef void (*InterruptHandlerFunction)(ProcessorContext*);
...
private:
    ...
    void setInterruptDescriptor(u8 vector, InterruptHandlerFunction handler, u16 selector, u8 type);
    void remapPIC();
...
public:
    ...
    void registerInterruptHandler(InterruptVector vector, InterruptHandlerFunction handler);
